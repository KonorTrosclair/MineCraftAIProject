...
Geting Started:
    ...
    Dependencies:
        Dependencies can be installed using Pip install command (pip install <dependency>):
            ...
            - minestudio
    To Run:
        (When running either train_agent.py or run_agent.py the vpt pretrained model should be cached automatically from HugginhFace an internet connection is required on first run though)
...
Special notes:
    ...
    Config:
        ...
        UPDATE_EVERY:
            ...
            - The value 200 for the UPDATE_EVERY worked well with 10GBs of VRAM and it is encouraged to increase or decrease if more or less VRAM is available.
